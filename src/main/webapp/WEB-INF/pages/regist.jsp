...
<style type="text/css">
<!--
em { font-weight: bold; padding-right: 1em; vertical-align: text-bottom; }
em.error {
  ...
  $(function(){
	...
	$("#username").change(function(){
		...
		if(username.length > 0 && username.length <= 16){
			var url = "${ pageContext.request.contextPath }/user/checkUserName.action";
	...
	$("#captchaImage").click(function(){
		this.src = "${ pageContext.request.contextPath }/checkcode.action?"+new  Date();
		alert($("#captcha").val());
	});
	 ...
	 $("#registerForm").validate({
			rules: {
				...
				captcha:{
					 required: true,
					  remote: {
	                        url: "${pageContext.request.contextPath }/user/checkcode.action",
	                        type: "post",
	                        dataType: "json",
	                        data: {
	                            "captcha": this.value,
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm" action=" ${ pageContext.request.contextPath }/user/regist.action" method="post">
						<table>
							<tbody>
								<tr>
									<th><span class="requiredField">*</span>用户名:</th>
									<td><input type="text" id="username" name="username"
										class="text" maxlength="20" /><div id="message"></div></td>
								</tr>
								<tr>
								...
								<tr>
									<th>地址:</th>
									<td><input type="text" name="addres"
										class="text" maxlength="200" /></td>
								</tr>
								<tr>
									...
									<td><span class="fieldSet"> <input type="text"
											...
											maxlength="4" autocomplete="off" /><img
												...
												src="${ pageContext.request.contextPath }/checkcode.action"
	...
	<div class="container footer">
 	...
 	<div id="_my97DP"
		...
		<iframe style="width: 190px; height: 191px;"
			src="<%=request.getContextPath() %>/image/My97DatePicker.htm"
