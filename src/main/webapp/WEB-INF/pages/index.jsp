		...
		<div class="span24">
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
				...
				<ul class="tabContent" style="display: block;">
					<s:iterator value="productHot" var="product">
						<li><a href="${pageContext.request.contextPath}/products/productdetail.action?pid=<s:property value="#product.pid" />" target="_blank"><img
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
				...
				<!-- 					<div class="newProductAd">
						 ...
						 -->
				<ul class="tabContent" style="display: block;">
					<s:iterator value="productNew" var="product">
					<li><a href="${pageContext.request.contextPath}/products/productdetail.action?pid=<s:property value="#product.pid" />" target="_blank"><img
							src="${pageContext.request.contextPath}/image/<s:property value="#product.image" />"
							style="display: block;" /></a></li>
							</s:iterator>					
