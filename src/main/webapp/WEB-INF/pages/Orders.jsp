...
<body>
	...
	<div class="container cart">
		...
		<div class="span24">
			...
			<table>
				<tbody>
					...
					<tr>
						...
						<td width="140"><span class="subtotal">￥100</span></td>
			...
			<div class="total">
				<em id="promotion"></em> 商品金额: <strong id="effectivePrice">￥100元</strong>
			</div>
			<form id="orderForm" action="./order_payOrder.action" method="post">
				<input type="hidden" name="order.oid" value="" />
				<div class="span24">
					<p>
						收货地址：<input name="order.user.addr" type="text" value=""
							style="width: 350px" /> <br /> 收货人&nbsp;&nbsp;&nbsp;：<input
							name="order.user.username" type="text" value=""
							style="width: 150px" /> <br /> 联系方式：<input
							name="order.user.phone" type="text" value="" style="width: 150px" />
					...
					<p>
						选择银行：<br /> <input type="radio" name="pd_FrpId"
							...
							src="${pageContext.request.contextPath}/image/bank_img/icbc.bmp" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="pd_FrpId" value="BOC-NET-B2C" />中国银行 <img
							src="${pageContext.request.contextPath}/image/bank_img/bc.bmp" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="pd_FrpId" value="ABC-NET-B2C" />农业银行 <img
							src="${pageContext.request.contextPath}/image/bank_img/abc.bmp" align="middle" /> <br /> <input
							type="radio" name="pd_FrpId" value="BOCO-NET-B2C" />交通银行 <img
							src="${pageContext.request.contextPath}/image/bank_img/bcc.bmp" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
						...
						<input type="radio" name="pd_FrpId" value="CCB-NET-B2C" />建设银行 <img
							src="${pageContext.request.contextPath}/image/bank_img/ccb.bmp" align="middle" /> <br /> <input
							type="radio" name="pd_FrpId" value="CEB-NET-B2C" />光大银行 <img
							src="${pageContext.request.contextPath}/image/bank_img/guangda.bmp" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
